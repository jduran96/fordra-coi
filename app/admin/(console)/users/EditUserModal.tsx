...
/** "Edit User" button + modal: assign a registered user to an existing org. */
export default function EditUserModal({
  ...
  // Close the modal once a save succeeds (the table revalidates behind it).
        ...
        <div onClick={e => { if (e.target === e.currentTarget) setOpen(false) }} style={overlay}>
          <div style={card}>
            ...
            <p style={{ fontSize: 13.5, color: C.txt2, fontFamily: C.sans, margin: '0 0 20px' }}>
              Assign a registered user to an organization.
            </p>

            <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <label style={lbl}>User
                <select name="profile_id" required defaultValue="" style={input}>
