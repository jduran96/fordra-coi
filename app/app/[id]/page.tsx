            ...
            <div key={i} style={{
              ...
              {(phone || email) && (
                <div style={{ margin: '0 0 12px' }}>
                  ...
                  {/* No overall legitimacy verdict chip here (owner call
                      2026-07-29, same rule as the admin table): tags are
                      per-field only, and the verdict stacked under the phone
                      tag read like a tag for a missing field. The blurb below
                      still carries any discrepancy in words. */}
